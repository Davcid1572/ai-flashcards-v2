  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        ...
        <span
          className={`text-xs ${
            wordCount < 30 && wordCount > 0 ? "text-amber-400" : "text-gray-500"
          }`}
        >
          {wordCount} {wordCount === 1 ? "word" : "words"}
          {wordCount < 30 && wordCount > 0 && " — need at least 30"}
        </span>
      </div>
      ...
      <textarea
        ...
        disabled={isLoading}
        placeholder="Paste any text here — notes, articles, textbook excerpts, documentation..."
        rows={10}
